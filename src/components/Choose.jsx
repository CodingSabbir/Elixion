...
const Choose = () => {
    return (
        <div className='mx auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 bg-[#F4F7FA]'>
             <div className='py-8'>
        <h1 className='text-center text-[28px] md:text-[40px] font-roboto text-[#161C2D] py-2'>Why you should choose us?</h1>
        ...
        <div className="px-4 sm:px-6   lg:px-8 lg:py-20 py-10 mx-auto max-w-screen-2xl ">
    ...
    <div class="  flex flex-col px-4 sm:px-6   lg:px-8 lg:py-20 py-10 mx-auto max-w-screen-2xl  relative overflow-hidden ">
  <div class="max-w-7xl mx-auto">
    <div class="relative group">
      <div class="absolute -inset-1 bg-gradient-to-r  to-pink-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
      <div class="relative px-7 py-6 bg-white ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
        <svg class="w-8 h-8 text-[#15F5BA]" fill="none" viewBox="0 0 24 24">
  ...
  <div class="max-w-7xl mx-auto block sm:hidden lg:block">
    <div class="relative group">
      <div class="absolute -inset-1 bg-gradient-to-r  to-pink-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
      <div class="relative px-7 py-6 bg-white ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
        <svg class="w-8 h-8 text-[#15F5BA]" fill="none" viewBox="0 0 24 24">
