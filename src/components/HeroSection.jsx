        ...
        <div
            ...
            <div className="max-w-xl text-center sm:text-left ">
                ...
                <div class="mt-8 flex flex-wrap gap-4 text-center">
                    ...
                    <a href="#"
                        class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-rose-600 shadow hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 sm:w-auto  items-center flex gap-2 justify-center">
